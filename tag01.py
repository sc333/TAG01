...
def main():
    ...
    while exploring: # main game loop
        ...
        if light>0 or axe>0 or sword>0 or amulet>0:
        ...
        #########################################################
        while True:
            vocabulary=["Q","N","S","E","W","U","D","R","F","I","C","P","M","H","?"]
            print
        ...
        if move.upper() == "F" and travelTable[roomNum-1][6] < 0:
            mK,fF,monster,strength,axe,sword,suit=battle(mK,fF,monster,strength,axe,sword,suit) 
